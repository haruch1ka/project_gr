...
export const mockKnowledge: Knowledge[] = [
  // 釣り - タイミング
  {
    ...
    confidenceScore: 0.8, type: 'hypothesis',
  ...
  },
  {
    ...
    webSources: [], supportingExperiences: [], contradictingExperiences: [],
    confidenceScore: 0.9, type: 'hypothesis',
  ...
  },
  {
    ...
    content: '夕マズメも侮れない',
    webSources: [], supportingExperiences: [], contradictingExperiences: [],
    confidenceScore: 0.5, type: 'hypothesis',
    tags: ['6/2 夕マズメで大物ヒット'],
    createdAt: '',
  },
  // 釣り - 道具・仕掛け
  {
    ...
    webSources: [], supportingExperiences: [], contradictingExperiences: [],
    confidenceScore: 0.95, type: 'hypothesis',
  ...
  // 釣り - まだわからないこと
  {
    ...
    content: '潮位の影響',
    webSources: [], supportingExperiences: [], contradictingExperiences: [],
    confidenceScore: 0.3, type: 'hypothesis',
    tags: [],
    createdAt: '',
  },
  {
  ...
  // 筋トレ
  {
    ...
    webSources: [], supportingExperiences: [], contradictingExperiences: [],
    confidenceScore: 0.85, type: 'hypothesis',
  ...
  },
  {
    ...
    webSources: [], supportingExperiences: [], contradictingExperiences: [],
    confidenceScore: 0.75, type: 'hypothesis',
  ...
  // 読書
  {
    ...
    webSources: [], supportingExperiences: [], contradictingExperiences: [],
    confidenceScore: 0.6, type: 'hypothesis',
